...
👉 **[Play it here](https://palaksharma032.github.io/Chess-Game/index.html)**
...
├── style.css    # Board styling, animations, responsive design
└── script.js    # Game logic — movement, check, checkmate, stalemate
```
...
- **Vanilla JavaScript** — Full game logic with no dependencies
